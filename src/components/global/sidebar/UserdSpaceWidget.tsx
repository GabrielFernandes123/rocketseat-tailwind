  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="space-x-6">
        <button
          type="button"
          className="text-small font-medium text-violet-500 hover:text-violet-700 dark:text-violet-300 dark:hover:text-violet-200 "
        >
          Dismiss
        </button>
        <button
          type="button"
          className="text-small font-medium text-violet-700 hover:text-violet-900 dark:text-zinc-300 dark:hover:text-zinc-100 "
        >
          Upgrade plan
        </button>
      </div>
